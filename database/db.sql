...
visita VARCHAR(50),
PRIMARY KEY (correo),
FOREIGN KEY (tipo_pago) REFERENCES Pago(tipo),
FOREIGN KEY (taller1) REFERENCES Taller1(nt1),
FOREIGN KEY(taller2) REFERENCES Taller2(nt2),
FOREIGN KEY(visita) REFERENCES Visita(nv)
);
